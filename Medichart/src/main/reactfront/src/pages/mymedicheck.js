                ...
                <tr>
                  <td>
                    <div className="form-wrap box-in-table">
                      ...
                      <div className={styles.inputContainer}>
                        <p className={styles.label}>수축기 혈압</p>
                        <input
                          type="text"
                          className={styles.ti_a1_1}
                          id="systcBpVl"
                      ...
                      <div className={styles.inputContainer}>
                        <p className={styles.label}>이완기 혈압</p>
                        <input
                          type="text"
                          className={styles.ti_a1_1}
                          id="distcBpVl"
                ...
                <tr>
                  <td>
                    <div className="form-wrap box-in-table">
                      ...
                      <div className={styles.inputContainer}>
                        <p className={styles.label}>공복혈당</p>
                        <input
                          type="text"
                          className={styles.ti_a1_1}
                          id="empstoBdsgVl"
                ...
                <tr>
                  <td>
                    <div className="form-wrap box-in-table">
                      ...
                      <div className={styles.inputContainer}>
                        <p className={styles.label}>총 콜레스테롤</p>
                        <input
                          type="text"
                          className={styles.ti_a1_1}
                          id="totClstrVl"
                      ...
                      <div className={styles.inputContainer}>
                        <p className={styles.label}>LDL-콜레스테롤</p>
                        <input
                          type="text"
                          className={styles.ti_a1_1}
                          id="ldlClstrVl"
                      ...
                      <div className={styles.inputContainer}>
                        <p className={styles.label}>중성지방</p>
                        <input
                          type="text"
                          className={styles.ti_a1_1}
                          id="tgClstrVl"
                      ...
                      <div className={styles.inputContainer}>
                        <p className={styles.label}>HDL-콜레스테롤</p>
                        <input
                          type="text"
                          className={styles.ti_a1_1}
                          id="hdlClstrVl"
                ...
                <tr>
                  <td>
                    <div class="form-wrap box-in-table">
                      ...
                      <div className={styles.inputContainer}>
                        <p class={styles.label}>혈청크레아티닌</p>
                        <input
                          type="text"
                      ...
                      <div className={styles.inputContainer}>
                        <p class={styles.label}>신사구체여과율(GFR)</p>
                        <input
                          type="text"
